...
<script>
function incQty(){let q=document.getElementById('qty');q.value=parseInt(q.value)+1;}
function decQty(){let q=document.getElementById('qty');if(q.value>1)q.value=parseInt(q.value)-1;}
</script>
    <!-- Footer -->
    <footer>

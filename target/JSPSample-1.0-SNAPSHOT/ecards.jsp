...
<head>
    ...
    <style>
        * {
        ...
        /* Promotional Banner */
        .promo-banner {
            background: url('https://png.pngtree.com/thumb_back/fw800/back_our/20190628/ourmid/pngtree-e-commerce-business-minimalistic-gradient-background-template-image_269273.jpg') center center/cover no-repeat;
            padding: 40px 0;
            margin-top: 80px;
            position: relative;
            overflow: hidden;
        ...
        <div class="container">
            <div class="promo-content">
                <div class="promo-left">
                    <div class="free-text">Các loại thiệp</div>
